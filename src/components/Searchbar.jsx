...
export default function Searchbar({
  ...
  const regions = ["Africa", "Americas", "Asia", "Europe", "Oceania"].map(
    (regionName) => (
      <MenuItem
      ...
      >
        ...
        <ListItemText inset={selectedRegion !== regionName}>
          {regionName}
        </ListItemText>
      </MenuItem>
    )
  ...
  const biggerThan500px = useMediaQuery((myTheme) =>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Menu anchorEl={sortElem} open={sortOpen} onClose={handleSortClose}>
          {sortCategories}
        </Menu>
        <Button
